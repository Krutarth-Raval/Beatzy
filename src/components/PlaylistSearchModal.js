...
import { Search, X, Music, User, Plus, Check, Loader2 } from 'lucide-react';

export default function PlaylistSearchModal({ onClose, onPlaylistSaved }) {
  ...
  return (
    <div className="modal-overlay animate-fade-in" onClick={onClose}>
      <div className="modal-content animate-scale-in" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '500px', width: '90%', padding: '24px', backgroundColor: 'var(--bg-main)', borderRadius: '16px', border: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column', height: '70vh' }}>
